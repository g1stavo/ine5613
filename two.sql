...
INSERT INTO Consultas VALUES (1, 1, "2016/10/12", 14:00),
...
1. UPDATE Pacientes SET cidade = 'Ilhota' WHERE nome = 'Paulo';

2. UPDATE Consultas SET data = '2013/11/04', hora = '12:00' WHERE codm = 1 AND codp = 4;

3. UPDATE Pacientes SET doenca = 'câncer' WHERE nome = 'Ana';

4. UPDATE Consultas SET hora = hora + '01:30' WHERE codm = 3 AND codp = 4;

5. DELETE FROM Funcionarios WHERE codf = 4;

6. DELETE FROM Consultas WHERE hora = '19:00';

7. DELETE FROM Consultas WHERE codp = (SELECT codp FROM Pacientes WHERE doenca = 'câncer' OR idade < 10);
   DELETE FROM Pacientes WHERE doenca = 'câncer' OR idade < 10;

8. DELETE FROM Medicos WHERE cidade = 'Biguacu' OR cidade = 'Palhoca';